...
export function RoutineDashboard({ initialRoutine }: RoutineDashboardProps) {
  ...
  return (
    <div className="space-y-6 max-w-full">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white border border-slate-200/80 shadow-sm dark:bg-[#12121a] dark:border-[#1e1e2d] rounded-2xl p-5">
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            ...
            <span className="text-xs text-slate-600 dark:text-[#a0a0a0] font-bold flex items-center gap-1">
          ...
          <p className="text-sm text-slate-600 dark:text-[#a0a0a0] font-semibold mt-0.5">
            {routine.subtitle}
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="bg-indigo-50/70 border border-indigo-200 dark:bg-indigo-950/30 dark:border-indigo-500/30 rounded-xl px-4 py-2 text-left sm:text-right min-w-[150px]">
          ...
          {/* Live EST Clock */}
          <div className="bg-slate-50 border border-slate-200 dark:bg-[#191926] dark:border-[#2a2a3e] rounded-xl px-4 py-2 text-right">
            <p className="text-[10px] font-bold text-slate-600 dark:text-[#737373] uppercase tracking-wider">
              Current EST Time
            </p>
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-white border border-slate-200 shadow-xs hover:bg-slate-50 text-slate-900 dark:bg-[#202030] dark:border-[#333348] dark:text-white dark:hover:bg-[#2a2a40] rounded-xl text-xs font-bold transition-all cursor-pointer active:scale-95"
          >
      ...
      {isEditing && (
        <div className="bg-white dark:bg-[#12121a] border-2 border-indigo-500/50 rounded-2xl p-5 shadow-2xl space-y-4">
          <div className="flex items-center justify-between border-b border-slate-200 dark:border-[#202030] pb-3">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-3.5 py-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-gray-800 text-xs font-bold rounded-xl text-slate-800 dark:text-gray-300 cursor-pointer"
              >
                Cancel
              </button>
              <button
                ...
                disabled={saving}
                className="px-4 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-xl flex items-center gap-1.5 disabled:opacity-50 cursor-pointer shadow-xs active:scale-95"
              >
          ...
          <div className="space-y-4 text-xs">
            <div>
              <label className="block font-bold text-slate-900 dark:text-gray-300 mb-1">Routine Title</label>
              <input
                type="text"
                value={editedRoutine.title}
                onChange={(e) => setEditedRoutine({ ...editedRoutine, title: e.target.value })}
                className="w-full bg-slate-50 dark:bg-[#191924] border border-slate-200 dark:border-[#2a2a3c] rounded-xl px-3 py-2 text-slate-900 dark:text-white font-bold text-sm"
              />
            </div>
            <div>
              <label className="block font-bold text-slate-900 dark:text-gray-300 mb-1">Subtitle / Time Window</label>
              <input
                type="text"
                value={editedRoutine.subtitle}
                onChange={(e) => setEditedRoutine({ ...editedRoutine, subtitle: e.target.value })}
                className="w-full bg-slate-50 dark:bg-[#191924] border border-slate-200 dark:border-[#2a2a3c] rounded-xl px-3 py-2 text-slate-900 dark:text-white text-sm"
              />
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <a
          ...
          className="flex items-center justify-between p-3.5 bg-white border border-slate-200/80 shadow-xs hover:border-amber-400 dark:bg-[#12121a] dark:border-[#1e1e2d] dark:hover:border-amber-500 rounded-xl transition-all group"
        >
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 dark:text-gray-400 font-medium">Check Red Folder Events</p>
            </div>
          </div>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-between p-3.5 bg-white border border-slate-200/80 shadow-xs hover:border-indigo-400 dark:bg-[#12121a] dark:border-[#1e1e2d] dark:hover:border-indigo-500 rounded-xl transition-all group"
        >
          <div className="flex items-center gap-2.5">
            <span className="text-base">📈</span>
            <div>
              ...
              <p className="text-[11px] text-slate-500 dark:text-gray-400 font-medium">DXY, US10Y, USOIL & SPY</p>
            </div>
          </div>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-between p-3.5 bg-white border border-slate-200/80 shadow-xs hover:border-purple-400 dark:bg-[#12121a] dark:border-[#1e1e2d] dark:hover:border-purple-500 rounded-xl transition-all group"
        >
          <div className="flex items-center gap-2.5">
            <span className="text-base">📰</span>
            <div>
              ...
              <p className="text-[11px] text-slate-500 dark:text-gray-400 font-medium">Scan Geopolitical News</p>
            </div>
          </div>
      ...
      <div className="bg-white border border-slate-200/80 shadow-sm dark:bg-[#12121a] dark:border-[#1e1e2d] rounded-2xl p-5 space-y-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 border-b border-slate-200/80 dark:border-[#1f1f2e] pb-3">
          <div className="flex items-center gap-2.5">
            <div className="p-2 kpi-icon-indigo rounded-xl">
            ...
            return (
              <div
                ...
                className={`cursor-pointer rounded-2xl p-4.5 border transition-all duration-200 space-y-3 relative overflow-hidden ${
                  isSelected
                    ? 'border-indigo-600 bg-indigo-50/80 dark:bg-indigo-950/40 shadow-md ring-2 ring-indigo-600/40'
                    : 'border-slate-200/90 bg-white hover:bg-slate-50/60 shadow-xs hover:border-indigo-400 dark:border-[#1e1e2d] dark:bg-[#161622] dark:hover:border-[#2c2c3e]'
                }`}
              >
                ...
                {/* Condition Tag Pill */}
                <div className="bg-slate-100/80 border border-slate-200/90 dark:bg-[#191926] dark:border-white/10 rounded-xl px-3 py-1.5 inline-block w-full">
                  <span className="text-[10px] uppercase tracking-wider font-extrabold text-slate-500 dark:text-[#737373] block mb-0.5">Condition</span>
      ...
      <div className="bg-red-50 border-2 border-red-300 text-red-950 dark:bg-red-950/40 dark:border-red-500/40 rounded-2xl p-4.5 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between border-b border-slate-200 dark:border-[#1e1e2d] pb-2">
          ...
          <span className="text-xs text-slate-500 dark:text-[#737373] font-semibold">
            ...
            return (
              <div
                ...
                className={`rounded-2xl border transition-all duration-300 overflow-hidden ${
                  isActive
                    ? 'border-indigo-400 bg-white dark:bg-gradient-to-r dark:from-indigo-500/10 dark:via-purple-50/5 dark:to-transparent shadow-lg ring-2 ring-indigo-400/30 dark:border-indigo-600'
                    : 'border-slate-200/80 bg-white shadow-sm dark:border-[#1e1e2d] dark:bg-[#12121a]'
                }`}
              >
                {/* Phase Header — left border accent strip */}
                <div className={`flex flex-col sm:flex-row sm:items-center justify-between gap-2 px-4 py-3.5 border-b border-slate-200 dark:border-[#1c1c2b] ${isActive ? 'bg-indigo-50/70 dark:bg-indigo-950/30' : 'bg-slate-50 dark:bg-[#161622]'}`}>
                    ...
                    return (
                      <div
                        ...
                        className={`flex items-start gap-3 p-3 rounded-xl border transition-all cursor-pointer ${
                          isChecked
                            ? 'bg-emerald-50 border-emerald-200 dark:bg-emerald-500/10 dark:border-emerald-500/30 opacity-75'
                            : 'bg-slate-50/80 border-slate-200/80 hover:bg-white hover:border-indigo-300 hover:shadow-sm dark:bg-[#171724] dark:border-[#222234] dark:hover:border-[#2f2f45]'
                        }`}
                      >
                        {/* Checkbox */}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {/* Action text */}
                          <span className={`text-xs sm:text-sm font-semibold leading-relaxed ${isChecked ? 'line-through text-slate-500 dark:text-slate-500' : 'text-slate-800 dark:text-slate-200'}`}>
                            {item.action}
                          </span>
                        </div>
                      </div>
      ...
      <div className="bg-[#f0f3ff] dark:bg-[#12121a] border-2 border-indigo-200 dark:border-[#1e1e2d] rounded-2xl p-6 shadow-sm space-y-5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-indigo-200/80 dark:border-[#1f1f2e] pb-4">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-500 flex-shrink-0">
              <Flame className="w-5 h-5" />
            </div>
            <div>
              <h2 className="text-lg font-black text-[#1e1b4b] dark:text-white tracking-tight uppercase">
                The Golden Rules (Read Aloud Every Morning)
              </h2>
              <p className="text-xs text-slate-600 dark:text-[#737373] font-semibold mt-0.5">
                Non-negotiable trading principles for risk control and emotional control.
              </p>
            </div>
          </div>
          <span className="text-xs font-black badge-backtest px-3.5 py-1 rounded-full self-start sm:self-auto shadow-xs border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3.5">
          {routine.rules.map((rule) => (
            <div
              key={rule.id}
              className="bg-white dark:bg-[#161622] border border-indigo-200/80 dark:border-[#1e1e2d] dark:hover:border-indigo-500/40 rounded-2xl p-4.5 space-y-2 transition-all shadow-xs"
            >
              <div className="flex items-center justify-between">
        ...
        <div className="bg-indigo-100/90 dark:bg-[#191926] border border-indigo-300 dark:border-indigo-500/30 rounded-2xl p-4.5 text-xs sm:text-sm text-[#1e1b4b] dark:text-indigo-200 leading-relaxed font-bold shadow-xs">
