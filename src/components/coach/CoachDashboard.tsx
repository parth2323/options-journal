...
export function CoachDashboard({ accounts }: CoachDashboardProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-4 sm:p-5 text-xs text-amber-800 dark:text-amber-300 space-y-2">
        <div className="flex items-center gap-2 font-black uppercase tracking-wider text-amber-700 dark:text-amber-400">
          ...
          <span>Legal & Regulatory Risk Disclaimer</span>
        </div>
        <p className="leading-relaxed text-[11px] text-amber-700/90 dark:text-amber-300/90">
          TradeVault AI Coach is an automated trading log analysis tool designed exclusively for personal trade reflection and educational organization. TradeVault is <strong>not</strong> a registered broker-dealer, investment advisor, or financial planner. Content generated by TradeVault AI does not constitute investment advice, financial planning, trade recommendations, or guarantees of future profit. Options, equities, and futures trading carry substantial risk of capital loss. Always consult a licensed financial professional before placing live market orders.
        </p>
      </div>
